...
model =  load_model('C:/Users/S.S.SRIRAM/OneDrive/Desktop/Accident Detection with UI/model/model.h5')
    ...
    while 1:
            ...
            if 'No' not in txt:
                    if count>=50:
                            ...
                            """+txt
                            cl.messages.create(body=message, from_='+18317062001', to='+919659449377')
